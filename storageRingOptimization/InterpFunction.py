...
def generate_3DInterp_Function_NUMBA(vecX,vecY,vecZ,xCoords,yCoords,zCoords):
    assert vecX.shape==vecY.shape and vecZ.shape==vecZ.shape
...
def generate_2DInterp_Function_NUMBA(v,xCoords,yCoords):
