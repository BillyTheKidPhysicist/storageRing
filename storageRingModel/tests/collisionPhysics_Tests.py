...
def test_trim_Momentum_To_Maximum():
    ...
    assert trim_Transverse_Momentum_To_Maximum(1000.0, 0.0, 1.0) == -trim_Transverse_Momentum_To_Maximum(-1000.0, 0.0, 1.0)
    assert trim_Transverse_Momentum_To_Maximum(1.0, 0.99999, 1.0) == -trim_Transverse_Momentum_To_Maximum(-1.0, 0.99999, 1.0)
    assert trim_Transverse_Momentum_To_Maximum(1.0, 0.99999, 1.0, Fcentrifugal=100) != -trim_Transverse_Momentum_To_Maximum(-1.0, 0.99999, 1.0)
