...
class testHelper:
    ...
    def test1(self):
        ...
        self.assert_Fields_And_Length(RMS1, RMS2, absMean1, absMean2, RMS1_0, RMS2_0, absMean1_0, absMean2_0, lens1,
                                      lens2)
    ...
    def assert_Fields_And_Length(self, RMS1, RMS2, absMean1, absMean2, RMS1_0, RMS2_0, absMean1_0, absMean2_0, lens1,
                                 lens2):
