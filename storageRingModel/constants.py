...
SIMULATION_MAGNETON = BHOR_MAGNETON / MASS_LITHIUM_7  # Simulation units bohr magneton. Described in model docstring
VACUUM_TUBE_THICKNESS: float = inch_To_Meter(.05)  # minimum weldable thickness of a vacuum tube, m
...
FLAT_WALL_VACUUM_THICKNESS = inch_To_Meter(1 / 8)  # minimum thickness of a flat wall under vacuum with dimension less
# than 1x1 foot
