...
from latticeElements.class_HalbachBenderSegmented import HalbachBender
...
Element = Union[CombinerHalbachLensSim, BenderIdeal, CombinerIdeal,
                CombinerSim, Drift, LensIdeal, HalbachBender, HalbachLensSim]

ELEMENT_PLOT_COLORS = {Drift: 'grey', LensIdeal: 'magenta', HalbachLensSim: 'magenta', CombinerIdeal: 'blue',
                       CombinerSim: 'blue', CombinerHalbachLensSim: 'blue', HalbachBender: 'black',
                       BenderIdeal: 'black'}
